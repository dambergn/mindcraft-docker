...
This is a copy of https://github.com/kolbytn/mindcraft/tree/main to add a minecraft server with the proper version required.  And I am looking to add a container for a ollama server.  So far this does not work, I can not get the bot to connect to the minecraft server.
